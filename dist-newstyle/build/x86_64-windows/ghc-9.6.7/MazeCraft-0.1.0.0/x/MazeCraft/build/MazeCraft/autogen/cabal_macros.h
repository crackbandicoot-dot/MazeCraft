...
/* package MazeCraft-0.1.0.0 */
#ifndef VERSION_MazeCraft
#define VERSION_MazeCraft "0.1.0.0"
#endif /* VERSION_MazeCraft */
#ifndef MIN_VERSION_MazeCraft
#define MIN_VERSION_MazeCraft(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MazeCraft */
...
#define CURRENT_COMPONENT_ID "MazeCraft-0.1.0.0-inplace-MazeCraft"
